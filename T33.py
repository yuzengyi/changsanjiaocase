...
if __name__ == "__main__":
        ...
        if  record['case（订单）'] == dingdan:
            ...
            for i in range(4):
                ...
                while(True):
                    ...
                    cargos1=yanzhandaizifailed_encase_cargos_into_container(cargos, case[count], VolumeGreedyStrategy)
    ...
    df = pd.DataFrame(A, columns=['订单号', '普通1号袋', '普通1号袋总体积和', '普通2号袋', '普通2号袋总体积和',
                                  '普通3号袋', '普通3号袋总体积和', '普通4号袋', '普通4号袋总体积和', '普通1号自营纸箱',
                                  '普通1号自营纸箱总体积和', '普通2号自营纸箱', '普通2号自营纸箱总体积和',
                                  '普通3号自营纸箱', '普通3号自营纸箱总体积和', '普通4号自营纸箱',
                                  '普通4号自营纸箱总体积和', '普通5号自营纸箱', '普通5号自营纸箱总体积和'])
    df.to_excel('hunheresultT3.xlsx', index=False, header=True)