...
if __name__ == "__main__":
    ...
    df = pd.DataFrame(A, columns=['订单号', '普通1号袋', '普通1号袋总体积','普通2号袋', '普通2号袋总体积','普通3号袋', '普通3号袋总体积','普通4号袋', '普通4号袋总体积'])#普通1号袋	普通2号袋	普通3号袋	普通4号袋
    df.to_excel('daizi3result.xlsx', index=False, header=True)