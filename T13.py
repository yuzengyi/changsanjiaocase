import pandas as pd
Vs = [47500,75000,132000,189000,1089000,1960000,4500000,4860000,10200000]#47500	75000	132000	189000
...
def process_excel_file(file_path):
    ...
    # 保存修改后的Excel文件
    df.to_excel('T1混合求解结果.xlsx', index=False)

process_excel_file('hunheresult.xlsx')
